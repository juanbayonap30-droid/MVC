...
<body>
        ...
        <div class="container">
            <div class="form-card">
                <div class="form-header">
                    ...
                    <p>Complete los datos para registrar un nuevo programa de formación</p>
                </div>

                <div class="info-box">
                    <p><strong>Nota:</strong> El código del programa debe ser único y corresponder al código oficial SENA</p>
                </div>

                <form action="index.php?controller=programa&action=store" method="POST">
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="prog_codigo">
                        ...
                        <div class="form-group">
                            <label for="tit_id">
                                ID Título<span class="required">*</span>
                            </label>
                            <input 
                                type="number" 
                                id="tit_id" 
                        ...
                        <div class="form-group">
                            <label for="prog_tipo">
                                Tipo de Programa<span class="required">*</span>
                            </label>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            const codigo = document.getElementById('prog_codigo').value;
            const denominacion = document.getElementById('prog_denominacion').value.trim();
            const titId = document.getElementById('tit_id').value;
            const tipo = document.getElementById('prog_tipo').value;
            
            if (!codigo || !denominacion || !titId || !tipo) {
                e.preventDefault();
